...
## 5. Powrót 2→3 dni: Murlo → Telves → Hof → Poznań — ✅ ZDECYDOWANE I WDROŻONE (2026-07-22)
Użytkownik zarezerwował Maurerhof w Telves/Racines (Val Ridanna, Alto Adige, Włochy) na noc 25→26.09 (5 dorosłych, 1 apartament) — ale samo w sobie POGARSZAŁO balans powrotu: Murlo→Telves tylko 527 km/5,9h, a Telves→Poznań aż 1041 km/10,5h (realnie ~12h+ z postojami, zbyt długo na ostatni dzień urlopu). Rozwiązanie: wykorzystać istniejący dzień buforowy 27.09 ("już w Poznaniu") jako trzeci dzień jazdy zamiast dnia wolnego w domu — bez wydłużania dat 12–27.09. Nowy podział: D14 Murlo→Telves (527 km, popołudnie wolne na Vipiteno/Val Ridanna), D15 Telves→Hof/Bawaria (505 km — Hof wybrany jako niemal idealny środek trasy, 505/547 km), D16 Hof→Poznań (547 km). Hof nocleg NIE jest jeszcze zarezerwowany — kandydaci: Dormero Hotel Hof (centrum) lub Brauereigasthof Falter (Unterkotzau, własny parking) — do zarezerwowania. `meta.duration_days` 15→16, dzień buforowy usunięty z planu (zastąpiony realnym dniem transitowym).
