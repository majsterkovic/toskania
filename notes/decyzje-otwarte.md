...
- **Nocleg** — ✅ POTWIERDZONA REZERWACJA: Casa vacanze Rosa, Via Nazionale 29, Ponte all'Ania, Barga (coords 44.0398411, 10.4932228). Sprostowanie 2026-07-25: adres Arsenale zapisany 19.07 był błędny (to Rosa był i jest wybraną, potwierdzoną rezerwacją, nie odrzuconym kandydatem). Wszystkie `drive_min` w D3/D5/D6 przeliczone OSRM-em na dokładne wartości z Ponte all'Ania. Szczegóły w [[Baza 1 - Barga]].
...
## 6. Morze (Wersylia) — ✅ ZDECYDOWANE I WDROŻONE (2026-08-03)
Pełne dane w [[Morze-Wersylia]]. Ustalenia: morze jest osiągalne **tylko z bloku Bargi** (dni 3–6); z Murlo poza zasięgiem. Woda we wrześniu **24–25 °C**, zachód słońca prosto w morze ok. **19:30**. Dwa realne warianty:
- **A — finał D4 (15.09)**: po Pizie pociąg do Viareggio (13–19 min), plaża + zachód + kolacja, powrót Viareggio→Lucca (16–26 min) do auta. Trójkąt kolejowy, zero cofania; ale D4 rośnie do ~15 h.
- **B — druga połowa D6 (17.09)**: D6 kończy się o 16:00 (najlżejszy dzień bloku). Wymiana [[Pieve di Careggine]] (0,5 h) na 4–5 h plaży, autem → dostępne dzikie plaże (Lecciona/Marina di Vecchiano). Powrót ~21:00–21:30, daily_km 73→~145.

**Decyzja użytkownika (2026-08-03): wariant A.** Morze ma być *akcentem* — „wypada odwiedzić i zobaczyć", **nie plażowaniem**. Odpada więc B (D6) i dzikie plaże w San Rossore (te mają sens tylko pod kąpiel/leżenie). Viareggio wygrywa, bo jako jedyne wybrzeże jest dostępne koleją, ma co oglądać poza samym piaskiem (Passeggiata Liberty, molo, Darsena) i knajpy otwarte po zmroku.
Feasibility potwierdzona: **ostatni pociąg Viareggio→Lucca 22:10** (przyjazd 22:31). Wdrożono krótką wersję: powrót pociągiem 20:15, baza 21:30, bez zasiadanej kolacji (cuoppo + gelato na deptaku). Piza skrócona do 2 h, slot na Wieżę na 15:00. Szczegóły wdrożenia w [[Morze-Wersylia]].
...
## 4. Nocleg tam: Kufstein → Unterhaching — ✅ ZDECYDOWANE I WDROŻONE (2026-07-22)
Użytkownik samodzielnie zarezerwował Hotel Fresh Inn w Unterhaching (pod Monachium, Grünwalderweg 20d) na noc 12→13.09 (5 dorosłych, 2 apartamenty). OSRM: dzień 1 Poznań→Unterhaching 935 km/9,5–10h (było 1010 km/10–11h do Kufsteinu), dzień 2 Unterhaching→Barga 645 km/8–8,5h (było 560 km/7–7,5h). Rozkłada km równiej między oba dni tranzytu tam, Kufstein zostaje tylko porannym punktem przejazdowym dnia 2 (tankowanie przed Austrią).
...
- **D5 (śr 16.09) — Lucca + Piza + Viareggio (★ POPULARNY)**:
  ...
  - *Realizacja (2026-09-16)*: pełny sukces planu — wspólna Lucca ze świetnym obiadem, po czym grupa podzieliła się idealnie pod swoje tempo: część grupy spędziła dłuższy, spokojny czas w Lukce i wróciła pociągiem bezpośrednio do bazy, a dwójka kontynuowała popołudniowy ciąg kolejowy do Pizy (Piazza dei Miracoli) oraz nad morze do Viareggio na zachód słońca. Zero stresu z autem, rozkłady pociągów zagrały perfekcyjnie.
