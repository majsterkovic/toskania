...
- **Fortezza delle Verrucole** otwarta we wrześniu tylko **pt–nd**, a blok Bargi to pon–czw. Nie da się przesunąć: dzień przyjazdu (nd) zajęty 7h trasą z Kufstein, dzień wyjazdu (pt) to transfer do Chianti w przeciwną stronę (na południe). Zostałby tylko bezpłatny spacer zewnętrzny.
- **Lago di Vagli**: zatopiona wioska Fabbriche di Careggine niewidoczna — **w 2026 jezioro pełne** (opróżnienie planowane na 2027). Nic do zobaczenia poza samą taflą wody.
...
## Prawdziwa trasa górska — ✅ WDROŻONA jako D5 (2026-07-19)
Użytkownik chciał prawdziwszą (nie tylko wieczorną), ale „nie ciężką, za to widowiskową" trasę górską. Zamiast poświęcać D3/D6 albo dodawać nowy dzień — okazało się, że **D5 to już jest „dzień na trasę"**, więc po prostu podmieniono treść tego dnia (Il Ciocco → Monte Forato), bez ruszania kalendarza.

**Najpierw sprawdzone z Komoota (`komoot.com/pl-pl/guide/565053/mountain-hikes-around-barga`) — zbyt trudne dla rodziny (wymagają doświadczenia alpejskiego):**
- Buca della Neve–Pania della Croce: 11,2 km, 5h15, 800 m, trudna.
- Monte Rondinaio/Giovo: 9,4–10,8 km, 4h+, ~550–570 m, trudna, start Lago Santo modenese (61–81 min — za daleko).
